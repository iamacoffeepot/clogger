...
class ObjectLocation:
    ...
    @classmethod
    @mcp_tool(name="ObjectLocationByGameId", description="Find interactive object (scenery) spawn locations by game ID. Returns x, y, plane, type, orientation for each instance. Objects include trees, rocks, doors, ladders, etc.")
    ...
    @classmethod
    @mcp_tool(name="ObjectLocationNear", description="Find interactive objects near world coordinates. Default radius 50 tiles, plane 0. Sorted by distance.")
